...
export declare type MiddlewareInterface = (
  request: RequestAndOptions,
  next: Function,
) => void;
export declare type BatchMiddlewareInterface = (
...
export declare type AfterwareInterface = (
  response: ResponseAndOptions,
  next: Function,
) => void;
export declare type BatchAfterwareInterface = (
  response: ResponseAndOptions,
  next: Function,
) => void;
